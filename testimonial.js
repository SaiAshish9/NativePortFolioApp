...
export  const Testimonial=()=>{
    return(
        <View style={{borderColor:'white',borderWidth:1,flex:1,alignItems:'center',justifyContent:'center',backgroundColor:'black',width:width,height:height}}>
...
<Text style={{color:'white',fontWeight:'bold',position:'absolute',bottom:27}}>
    Testimonial Section
</Text>
...
<View  style={{padding:10,alignItems:'center',justifyContent:'center',width:width*0.7,height:height*0.7,borderColor:'white',borderWidth:1}}>
